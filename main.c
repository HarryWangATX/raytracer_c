...
int main() {
    ...
    lambertian mat_center = make_lambertian(initValue(0.7, 0.3, 0.3));
    metal mat_left = make_metal(initValue(0.8, 0.8, 0.8));
    metal mat_right = make_metal(initValue(0.8, 0.6, 0.2));
    ...
    material *material_left   = create_material(METAL, create_surface(METAL, &mat_left));// make_shared<metal>(color(0.8, 0.8, 0.8));
